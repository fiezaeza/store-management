...
import { saveOrders } from "@/lib/action";

const CreateOrdersPage = () => {
    const [state, formAction] = useFormState(saveOrders, null);

    return (
        <div className="container mx-auto p-6 max-w-lg mt-10">
            <h1 className="text-4xl font-bold text-center mb-8 text-white">Add New Order</h1>
